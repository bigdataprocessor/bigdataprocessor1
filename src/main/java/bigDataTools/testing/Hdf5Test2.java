...
public class Hdf5Test2 {
    ...
    //private static String fname  = "/Users/tischi/Desktop/HDF5SubsetSelect.h5";
    private static String fname  = "/Users/tischi/Desktop/example-data/luxendo/Cam_Left_00000.h5";

    //private static String dsname  = "2D 32-bit integer 20x10";
    private static String dsname  = "Data";
        ...
        public static void main(String args[]) throws Exception {
            ...
            try
            {
                if (file_id >= 0)
                {
                    ...
                    n = H5.H5Sget_simple_extent_ndims(filespace_id);

                    long[] dims = new long[n];
                    H5.H5Sget_simple_extent_dims(filespace_id, dims, null);
                    for ( long dim : dims )
            ...
            //int[][][] dataRead = new int[1][300][300];
            short[][][] dataRead = new short[1][50][50];

            // Define and select the hyper-slab to use for reading.
            try {
                if (dataset_id >= 0) {
                    filespace_id = H5.H5Dget_space(dataset_id);
                    ...
                    if (filespace_id >= 0) {
                        ...
                        //long offset = H5.H5Dget_offset(dataset_id);
            ...
            for (int z = 0; z < 1; z++) {
                for (int y = 0; y < 10; y++) {
                    ...
                    for (int x = 1; x < 10; x++)
                    {
                        System.out.print("," + dataRead[z][y][x]);
                    }
                }
            }
