...
public abstract class Hdf5Utils {
    ...
    public static void writeIntegerAttribute( int dataset_id, String attrName, int[] attrValue )
    {
    ...
    public static void writeDoubleAttribute( int dataset_id, String attrName, double[] attrValue )
    {
    ...
    public static void writeLongArrayListAs32IntArray( int group_id, ArrayList< long[] > list, String name )
    {
    ...
    public static void writeLongArrayListAsDoubleArray( int group_id, ArrayList < long[] > list, String name )
    {
    ...
    public static void writeIntArrayListAsDoubleArray( int group_id, ArrayList < int[] > list, String name )
    {
    ...
    public static int createGroup( int file_id, String groupName )
    {
        int group_id;
