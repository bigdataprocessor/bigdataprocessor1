...
public class SaveVS2Frame implements Runnable {
    ...
    public SaveVS2Frame(BigDataProcessor bigDataProcessor,
                        int t,
                        SavingSettings savingSettings,
                        ImarisDataSet imarisDataSetProperties,
                        AtomicInteger counter,
    ...
    private ImagePlus getDataCube( int c )
    {
        ...
        if ( savingSettings.imp.getStack() instanceof VirtualStack2 )
        {

            VirtualStack2 vs2 = ( VirtualStack2 ) savingSettings.imp.getStack();

            if ( vs2.getFileType().equals( Utils.FileType.TIFF_PLANES.toString() ) )
            {
            ...
            {
                impChannelTime = vs2.getFullFrame( c, t, savingSettings.nThreads );
            }
        }
        else
        {
