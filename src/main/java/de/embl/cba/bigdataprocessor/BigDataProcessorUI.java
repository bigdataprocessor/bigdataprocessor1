...
public class BigDataProcessorUI extends JFrame implements ActionListener, FocusListener, ItemListener
{
    ...
    public void showDialog()
    {
        ...
        this.setTitle("Big Data Processor");
        this.add( tabbedPane );
    ...
    {
        String[] toolTipTexts = getToolTipFile( "BigDataProcessorHelp.html" );
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        if (e.getActionCommand().equals(BROWSE_FOLDER))
        {
            ...
            Thread thread = new Thread( () -> bigDataProcessor.openFromDirectory(
                    inputFolder,
					namingScheme,
					filterPattern,
					h5DataSet,
        ...
        else if (e.getActionCommand().equals(STREAMfromInfoFile))
        {
            ...
            ImagePlus imp = bigDataProcessor.openFromInfoFile(file.getParent() + "/", file.getName());
            imp.show();
        ...
        else if (e.getActionCommand().equals(LOAD_FULLY_INTO_RAM))
        {
            ...
            Thread t1 = new Thread(new Runnable() {
                public void run() {
                    ImagePlus impRAM = bigDataProcessor.loadVS2FullyIntoRAM(IJ.getImage(), nIOthreads);
                    if (impRAM != null)
                    {
                        impRAM.show();
                    }
        ...
        else if ( e.getActionCommand().equals( CROP ) )
        {
            ...
            // compute
            //
            ImagePlus imp2 = bigDataProcessor.getCroppedVS2(
                    imp, imp.getRoi(),
            ...
            String url = "https://github.com/embl-cba/fiji-plugin-bigDataProcessor/issues";
