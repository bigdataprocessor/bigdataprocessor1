package de.embl.cba.bigdataprocessor.hdf5;
...
import static de.embl.cba.bigdataprocessor.hdf5.H5Utils.writeDoubleAttribute;
import static de.embl.cba.bigdataprocessor.hdf5.H5Utils.writeStringAttribute;
...
public class H5DataCubeWriter
{
    ...
    private void setMemoryTypeAndFileType( ImagePlus imp )
    {
        ...
        if ( imp.getBitDepth() == 8 )
        {
            ...
            file_type = HDF5Constants.H5T_NATIVE_UCHAR;   // H5T_STD_U8LE;
        }
        else if ( imp.getBitDepth() == 16 )
        {
            memory_type = HDF5Constants.H5T_NATIVE_USHORT;
            file_type = HDF5Constants.H5T_NATIVE_USHORT; // H5T_STD_U16LE;
        }
        else if ( imp.getBitDepth() == 32 )
        {
            memory_type = HDF5Constants.H5T_NATIVE_FLOAT;
            file_type = HDF5Constants.H5T_NATIVE_FLOAT; // H5T_IEEE_F32LE;
        }
        else
        {
