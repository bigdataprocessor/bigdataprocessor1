...
import de.embl.cba.bigdataconverter.saving.SaveVS2Frame;
import de.embl.cba.bigdataconverter.saving.SavingSettings;
import de.embl.cba.bigdataconverter.utils.ImageDataInfo;
import de.embl.cba.bigdataconverter.utils.MonitorThreadPoolStatus;
...
public class BigDataConverter
{
    ...
    )
    {
        ...
        if ( namingScheme.equals( BigDataConverterUI.LOAD_CHANNELS_FROM_FOLDERS) )
        {
            //
        ...
        if ( namingScheme.equals( BigDataConverterUI.LEICA_SINGLE_TIFF ) ) // isLeicaSinglePlaneTiffFileType( fileLists[ 0 ] ) )
        {
        ...
        else // tiff stacks or h5 stacks
        {
            ...
            else if ( namingScheme.equals( BigDataConverterUI.EM_TIFF_SLICES ) )
            {
                nC = 1;
                nT = 1;
                imageDataInfo.fileType = Utils.FileType.TIFF_PLANES.toString();
            ...
            if ( fileLists[0][0].endsWith(".tif") )
            {
                ...
                if ( namingScheme.equals( BigDataConverterUI.EM_TIFF_SLICES ) )
                {
                    imageDataInfo.fileType = Utils.FileType.TIFF_PLANES.toString();
